...
@class LLBugsnagHandledState;
@class LLBugsnagSession;
...
@interface LLBugsnagCrashReport : NSObject

/**
 *  Create a new crash report from a JSON crash report generated by
 * LLBugsnagCrashSentry
 *
 *  @param report a LLBugsnagCrashSentry JSON report
 *  @param metadata additional report info encoded as a string
 *
 *  @return a LLBugsnag crash report
 */
 ...
 *  @param config    LLBugsnag configuration
 ...
 */
@property(readonly, nonnull) LLBugsnagHandledState *handledState;
